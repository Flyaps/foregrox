...
def replace_background_grabcut(image, color=255):
...
def replace_background_edge(image):
    img = image.copy()
    image = change_contrast(image)
    ...
    significant = find_significant_contours(edge_img_8u)
